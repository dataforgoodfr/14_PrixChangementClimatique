...
SELECT
    ...
    CAST(RANDOM() AS DECIMAL(3, 2)) AS score_economique,
    CAST(RANDOM() AS DECIMAL(3, 2)) AS score_georisque,
    CAST(RANDOM() AS DECIMAL(3, 2)) AS score_assurance,
    CAST(RANDOM() AS DECIMAL(3, 2)) AS indice_vulnerabilite,
